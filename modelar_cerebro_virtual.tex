...
\begin{frame}{Modelo 3D de flujo de corriente en el estrecho}
  \playVideoMovie{221.67px}{211.67px}{video/gibraltar-tubes-3d-30s.mp4}
...
\begin{frame}{Tsunami frente al cabo de San Vicente}
  \playVideoMovie{221.67px}{211.67px}{video/tsunami2.avi}
...
\begin{frame}{Matemáticas en Ingeniería}
  \playVideoMovie{}{}{video/vortices-von-karman.avi}
...
\begin{frame}{~}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item $\mathcal{N}_2(\theta;x)=\sigma(W_2\mathcal{N}_1+b_2);$
      \item $\cdots$
